    ...
    return (
      <div className="text-center py-16 space-y-4">
        ...
        <p className="text-xs text-neutral-500 max-w-sm mx-auto">
          You must be actively enrolled in this course to view lecture details.
        </p>
        <Button
          onClick={() => navigate("/students/lectures")}
          size="sm"
      ...
      <div className="p-6 rounded-3xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 shadow-sm space-y-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pt-2 border-t border-neutral-100 dark:border-neutral-800">
          ...
          <div className="flex items-center gap-3">
            {lecture.attendedLive && (
              <Badge className="bg-emerald-500/20 text-emerald-500 border-emerald-500/30 text-xs py-1 px-3">
                ✓ Attendance Recorded
              </Badge>
            )}
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-4 space-y-6">
          <div className="p-5 rounded-3xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 shadow-sm space-y-3">
            ...
            <div className="flex items-center gap-2.5 p-3 rounded-2xl bg-neutral-50 dark:bg-neutral-950 border border-neutral-200/60 dark:border-neutral-800">
              <div className="w-9 h-9 rounded-full bg-neutral-200 dark:bg-neutral-800 flex items-center justify-center font-bold text-xs">
              ...
              <div className="truncate">
                ...
                <p className="text-[10px] text-neutral-500">Live Cohort Instructor</p>
              </div>
            </div>
            ...
            {lecture.courseSlug && (
              ...
              >
                <Link to={`/learn/${lecture.courseSlug}`}>Open Full Course Classroom</Link>
              </Button>
            )}
          </div>
        </div>
